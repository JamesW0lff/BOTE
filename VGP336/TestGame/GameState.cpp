...
void GameState::Update(float deltaTime)
{
	...
	time += deltaTime;
	// Bouncing the ball
	mBall.transform.position.y = 1.0f + abs(sinf(time * mBounceSpeed)) * 3.0f;
...
void GameState::DebugUI()
{
	...
	{
		ImGui::DragFloat("Scale X##Scale", &mBall.transform.scale.x, 0.0f, 0.01f, 10.0f);
		ImGui::DragFloat("Scale Y##Scale", &mBall.transform.scale.y, 0.0f, 0.01f, 10.0f);
		ImGui::DragFloat("Scale Z##Scale", &mBall.transform.scale.z, 0.0f, 0.01f, 10.0f);
