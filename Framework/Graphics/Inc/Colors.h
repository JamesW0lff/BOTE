...
namespace BOTE::Graphics
{
	...
	namespace Colors
	{
		...
		// constexpr Color DarkRed{ 1.000000000f, 0.078431375f, 0.576470613f, 1.000000000f };
		...
		// constexpr Color Red{ 1.000000000f, 0.411764741f, 0.705882370f, 1.000000000f };
