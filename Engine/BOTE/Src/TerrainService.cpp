...
// 	if (index == 0)
// 		mTerrainRenderObject.diffuseMapId = tm->LoadTexture("../../Assets/Images/grass_2048.jpg");
// 	else
// 		mTerrainRenderObject.specularMapId = tm->LoadTexture("../../Assets/Images/dirt_seamless.jpg");
// }
// 
